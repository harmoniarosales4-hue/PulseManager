...
if __name__ == "__main__":
    ...
    test_msg1 = InboxMessage(platform=Platform.instagram, author="Alice", content="Hello!")
    print("Draft reply (ReplyGenerator):", generator.generate_reply(test_msg1))

    # ----- Test ApprovalManager -----
    test_msg2 = InboxMessage(platform=Platform.reddit, author="Bob", content="Nice post!")
